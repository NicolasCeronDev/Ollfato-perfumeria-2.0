...
// --- CONSULTA PARA OBTENER LAS CATEGOR\u00CDAS DE PERFUMES MASCULINOS ---
// Necesitamos obtener las categor\u00EDas (Citricas, Amaderadas, etc.) que est\u00E1n asociadas al g\u00E9nero Masculino.
// Seg\u00FAn tu tabla 'generos_perfumes', el ID para 'Masculino' parece ser el 1 (aunque la entrada es 'Maculino', usaremos el ID 1).
$sql_categorias = "SELECT id_categoria, nombre_categoria FROM categorias WHERE id_genero_perfume = 1 ORDER BY nombre_categoria ASC"; // Ordenamos por nombre alfab\u00E9ticamente
...
<head>
    ...
    <link rel="stylesheet" href="Productosparael.css">
...
<body>
    <header class="Header">
            ...
            <nav class="navbar">
                ...
                <div>
                    <ul>
                        ...
                        <li><a href="productosparaella.php" class="bar">Perfumes Para Ellas</a></li>
        ...
        <div class="titulo">
            <h1>
                <center> Perfumes para el </center>
            </h1>
            <p> En Olfato Perfumería, ofrecemos una exquisita selección de perfumes de las mejores marcas, diseñados
    ...
    <div class="exploraesencias">
        ...
        <div class="esenciasfotos">
            <div class="esencias3">
                <center> <img src="Contenido/LauProductos/EsenciaCitrica.jpg"> </center>
                <center>
                    <h3> Cítricas </h3>
                </center>
                <center>
            ...
            <div class="esencias3">
                <center> <img src="Contenido/LauProductos/amaderado.jpg"> </center>
                <center>
                    <h3> Amaderadas </h3>
                </center>
                <center>
   ...
   <?php
// Verificar si se encontraron categorías masculinas
if ($resultado_categorias && $resultado_categorias->num_rows > 0) {
    ...
    while($categoria = $resultado_categorias->fetch_assoc()) {
        ...
        // --- Consulta SECUNDARIA: Obtener PRODUCTOS para esta CATEGORÍA y el género Masculino ---
        $sql_productos_por_categoria = "SELECT id_producto, nombre, descripcion, imagen_url
                                      FROM productos
                                      WHERE id_genero_perfume = 1
    ...
    echo "<p>No se encontraron categorías de perfumes para él en la base de datos.</p>";
}
?>
