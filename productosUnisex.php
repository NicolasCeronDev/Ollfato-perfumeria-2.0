...
// --- CONSULTA PARA OBTENER TODOS LOS PERFUMES UNISEX ---
// Seg\u00FAn tu tabla 'generos_perfumes', el ID para 'Unisex' es el 3.
$sql_productos_unisex = "SELECT id_producto, nombre, descripcion, imagen_url
                        FROM productos
                        WHERE id_genero_perfume = 3"; // Filtra por g\u00E9nero UNISEX (ID 3)
$resultado_productos_unisex = $conexion->query($sql_productos_unisex);
...
<body>
    ...
    <section class="productos">
        <div class="seccionperfumes">
            <?php
            // Verificar si se encontraron productos unisex
            if ($resultado_productos_unisex && $resultado_productos_unisex->num_rows > 0) {
                // --- Bucle: Recorrer cada PRODUCTO unisex ---
                while ($producto = $resultado_productos_unisex->fetch_assoc()) {
            ...
            <?php
                ...
                echo "<p>No se encontraron productos unisex en este momento.</p>";
            }
            ?>
        </div>
    </section>
